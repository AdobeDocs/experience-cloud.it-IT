...
Un flag di funzione in Experience Rollout segue questo tipico ciclo di vita:
...
4. Facoltativamente, il flag viene aggiunto a una [versione](release-management.md) per il coordinamento tra i team.
